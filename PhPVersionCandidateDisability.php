...
$featurearray = array("Gender" => array("Man","Woman"),"Race/Ethnicity" => array("Black","White","Hispanic"),"Disability" => array("Autism","Paralysis","Depression","Bipolar Disorder","Stroke","Blindness","Epilepsy","No Disability"),"Party" => array("Republican","Democrat"),"Position on Abortion" => array("Abortion should be legal until 20 weeks into a pregnancy, after which some restrictions are appropriate.","Abortion should remain legal without restriction.","Abortion should remain legal without restriction. Congress should repeal the Hyde Amendment, which prohibits federal funds from paying for abortions."),"Position on Social Security" => array("Congress should consider Social Security cuts, like raising the retirement age and cutting future benefits.","Congress should not cut Social Security benefits, leaving the retirement age and current benefit levels where they are.","Congress should not cut Social Security benefits, leaving the retirement age where it is. Benefits should also be increased to be more generous."),"Position on Taxes" => array("Tax rates are too high and should be cut.","Tax rates should remain where they are. ","Tax rates are too low and should be raised."),"Position on Immigration" => array("Congress should increase funding for border security, while leaving legal immigration rates where they are.","Congress should give undocumented workers a path to citizenship and increase legal immigration.","Congress should permit an open border, allowing new immigrants to enter without restriction."),"Position on Healthcare" => array("The Affordable Care Act should remain in place, but no further measures are necessary to expand the federal government’s role in health care.

","The Affordable Care Act should remain in place, but it needs to be expanded to cover more people and reduce the cost of insurance.","The Affordable Care Act doesn’t go far enough. Instead, Congress should pass Medicare for All, replacing private insurance with a single federally operated program.
